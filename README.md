...
trying to teach https://dood.al/pinktrombone/ "more human sounds" aka "speaking" by hooking it to a Voice recognition software and applying ML
...
# in OSX system prefference, set in- and output to soundflower 2ch interfach
```
